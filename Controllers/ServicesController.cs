...
namespace BeautySaloonAPI.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        /// <summary>
        /// выводит сервисы по первичносу ключу
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        // GET: api/Services/5
        ...
        /// <summary>
        /// выводит категории по первичносу ключу
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        // GET: api/Services/Categories/5
        [HttpGet("Categories/{categoryId}")]
        public async Task<ActionResult<List<Services>>> GetServiceCategory(int categoryId)
        {
